...
def uj_oldal():
    ...
    path = r'C:\Users\ACER\PycharmProjects\Beadando_feladat\Adatok.xlsx'
    def megnyit():
        adatok = pd.read_excel(path)

        for item in adatok:
            lista.insert(END, adatok.values)

    lista = Listbox(uj_ablak, width=100)
    lista.pack(pady=20)
